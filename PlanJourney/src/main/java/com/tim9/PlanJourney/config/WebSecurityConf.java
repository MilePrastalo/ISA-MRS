	...
	// Implementacija PasswordEncoder-a koriscenjem BCrypt hashing funkcije.
		...
		protected void configure(HttpSecurity http) throws Exception {
			http
				...
				.antMatchers(HttpMethod.GET,"/api/searchHotels/**").permitAll()
		...
		public void configure(WebSecurity web) throws Exception {
			...
			web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html", "/**/*.css", "/**/*.js","/api/vehicleSearch","/api/getProducers","/api/getTypes","/api/addRC","/api/testFlightData","/api/getFlight/{id}","/api/searchFlightCompanies/{companyName}","/api/getReservationRequest/{requestId}", "/api/confirmReservationRequest/{requestId}", "/api/refuseReservationRequest/{requestId}");
