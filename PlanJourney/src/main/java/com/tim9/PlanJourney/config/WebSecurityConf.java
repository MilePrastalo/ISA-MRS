...
public class WebSecurityConf extends WebSecurityConfigurerAdapter {
	...
	// Implementacija PasswordEncoder-a koriscenjem BCrypt hashing funkcije.
		...
		public void configure(WebSecurity web) throws Exception {
			...
			web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html", "/**/*.css", "/**/*.js","/api/vehicleSearch","/api/getProducers","/api/getTypes","/api/addRC","/api/testFlightData","/api/getFlight/{id}","/api/searchFlightCompanies/{companyName}");
